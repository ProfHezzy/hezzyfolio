...
$auth_users = array(
    'seo' => '$2y$10$iJu9VGKeYxnF0xwGNFuXoO4EASkY55o.BqUSW3eIaD.XI7bYMo6OK', //admin@123
                        ...
                        <div class="card fat <?php echo fm_get_theme(); ?>">
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="mb-3">
                                       <div class="brand">
                                            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" M1008 width="100%" height="80px" viewBox="0 0 238.000000 140.000000" aria-label="H3K SEOSEOSEO">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="" target="_blank" class="app-v-title"> FMFMFMFM <?php echo VERSION; ?></a></h3></p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="" target="_blank" class="float-right text-muted">SEOSEOSEO <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="" target="_blank" class="float-right text-muted">SEOSEOSEO <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'SEOSEOSEO<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'SEOSEOSEO';      $tr['en']['AppTitle']           = 'SEOSEO';
